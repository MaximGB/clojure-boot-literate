...
# HTML export theming:
# --------------------
#+HTML_HEAD: <meta http-equiv="Content-Security-Policy" content="script-src 'self' www.pirilampo.org; style-src 'self' www.pirilampo.org; upgrade-insecure-requests"/>
#
