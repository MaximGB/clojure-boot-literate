...
# HTML export theming:
# --------------------
#+HTML_HEAD: <meta http-equiv="Content-Security-Policy" content="script-src 'self' 'unsafe-inline' www.pirilampo.org; style-src 'self' 'unsafe-inline' www.pirilampo.org"/>
#
