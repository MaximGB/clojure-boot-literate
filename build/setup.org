...
# HTML export theming:
# --------------------
#+HTML_HEAD: <meta http-quiv="Content-Security-Policy" content="script-src 'self' http://www.pirilampo.org; style-src 'self' http://www.pirilampo.org; upgrade-insecure-requests"/>
#
